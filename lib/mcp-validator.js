...
/**
 * @deprecated since design-system-rethink — replaced by lib/brand-validator.js > brandExists.
 * Kept for backward-compat (callers reading legacy mui MASTER.md). Will be removed in next major.
 */
...
/**
 * @deprecated since design-system-rethink — design phase now uses brand DESIGN.md (lib/brand-validator.js).
 * runGenerate produced mui MASTER.md, no longer wired into the design flow.
 * Kept for backward-compat with legacy hooks/scripts; will be removed in next major.
 */
