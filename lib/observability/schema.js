...
const EVENT_TYPES = {
  ...
  // plan-scope-contract — SC-01/02 측정용
  PLAN_COMPLETED:           'plan_completed',
  PLAN_REWRITE_REQUESTED:   'plan_rewrite_requested',
  // adaptive workflow Phase 1 shadow
...
const EVENT_SCHEMAS = {
  ...
  'classification.completed': {
    required: [
      'runId', 'feature', 'host', 'mode', 'classifierVersion',
      'requestHash', 'requestSummary', 'redactionApplied', 'redactedFields',
      'profile', 'assurance', 'compileSignals', 'phaseGraph', 'legacyExecutionChanged',
    ],
  },
};
