...
> 참조 문서: `docs/ci-bootstrap/plan/main.md`
...
Do 단계에서 `README.md` 또는 `docs/ci-bootstrap/do/main.md`에 추가할 가이드:
...
| docs-ops | `docs/ci-bootstrap/do/main.md`, `docs/ci-bootstrap/qa/main.md` | create |
