...
| F8 | Branch protection 안내 | GitHub Settings → Branches 가이드 | `docs/ci-bootstrap/design/main.md` 또는 README | Should | 미구현 |
...
| SC-08 | Branch protection 가이드 문서화 (Should) | `docs/ci-bootstrap/design/` 섹션 존재 |
...
|------|--------|
| 기획 (CEO) | 본 문서 ✅ |
| 설계 (COO) | `docs/ci-bootstrap/design/main.md` — YAML 구조 + F6/F10 옵션 결정 |
| 구현 (COO) | workflow YAML + (옵션) 공용 스크립트 + README 뱃지 |
| QA (COO + CSO) | 테스트 PR 생성으로 실제 트리거 확인 + OWASP + 권한 |
| 보고 | `docs/ci-bootstrap/report/main.md` |
