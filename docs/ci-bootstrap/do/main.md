...
> 참조 문서: `docs/ci-bootstrap/plan/main.md`, `docs/ci-bootstrap/design/main.md`
...
| `docs/ci-bootstrap/do/main.md` | **create** | 본 문서 |
...
| SC-08 | `docs/ci-bootstrap/design/main.md §5` + README 섹션 존재 | 완료 |
