...
>
> 🌀 **Dogfooding**: 이 문서가 `docs/docs-structure-redesign/plan/main.md` 경로에 저장되는 것 자체가 피처 중심 구조(`docs/{feature}/{phase}/main.md`)의 첫 산출물입니다.
...
3. 결과(현재): 에이전트 문서 지시(`docs/01-plan/cto_foo-bar.plan.md`)와 config(`docs/foo-bar/plan/main.md`)가 충돌해 어느 쪽에 생성되는지 예측 불가
4. 결과(목표): 모든 참조가 일관되어 `docs/foo-bar/plan/main.md` 하나에 결정적으로 생성됨
...
| 2 | 워크플로우 사용자 | `/vais cto do foo` 실행 시 산출물이 결정적으로 `docs/foo/do/main.md`에 생성되기를 | 피처 단위로 산출물을 추적하고 싶다 |
...
| 4 | agents/cto/ 실행 에이전트 갱신 | 7개 (infra-architect, backend-engineer, frontend-engineer, test-engineer, ui-designer, db-architect, incident-responder) | `docs/02-design/{role}_{feature}.design.md` → `docs/{feature}/design/main.md` 등 | Must | 미구현 |
...
- **예외 흐름**: 다중 산출물을 가진 에이전트(예: `infra-architect`)는 `docs/{feature}/design/infra.md` 같은 sub-doc 규칙 채택(§5.1 참조)
...
| 레거시 패턴 | 새 패턴 |
|-------------|---------|
| `docs/00-ideation/{role}_{feature}.md` | `docs/{feature}/ideation/main.md` |
| `docs/01-plan/{role}_{feature}.plan.md` | `docs/{feature}/plan/main.md` |
| `docs/02-design/{role}_{feature}.design.md` | `docs/{feature}/design/main.md` |
| `docs/02-design/infra-architect_{feature}.design.md` | `docs/{feature}/design/infra.md` (sub-doc) |
| `docs/03-do/{role}_{feature}.do.md` | `docs/{feature}/do/main.md` |
| `docs/04-qa/{role}_{feature}.qa.md` | `docs/{feature}/qa/main.md` |
| `docs/05-report/{role}_{feature}.report.md` | `docs/{feature}/report/main.md` |
...
| SC-06 | dogfooding 완수 | `docs/docs-structure-redesign/plan/main.md` 존재 (본 문서) + do/qa/report도 동일 구조로 생성 |
...
| `docs/docs-structure-redesign/plan/main.md` | create | 본 문서 (Plan 산출물) |
...
| 단계 | 산출물 |
|------|--------|
| 기획 | 본 문서 (`docs/docs-structure-redesign/plan/main.md`) ✅ |
| 설계 | `docs/docs-structure-redesign/design/main.md` — 치환 스크립트 설계 + 에이전트 문서 rewrite 전략 |
| 구현 (Do) | `docs/docs-structure-redesign/do/main.md` + 실제 코드 변경 29개 파일 |
| QA | `docs/docs-structure-redesign/qa/main.md` — SC-01~06 검증 |
| 보고 | `docs/docs-structure-redesign/report/main.md` — 재발 방지 CI guard 제안 포함 |
