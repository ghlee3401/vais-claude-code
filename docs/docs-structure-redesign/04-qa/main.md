...
> 참조 문서: `docs/docs-structure-redesign/01-plan/main.md`, `docs/docs-structure-redesign/02-design/main.md`, `docs/docs-structure-redesign/02-design/cso-review.md`, `docs/docs-structure-redesign/03-do/main.md`
...
| Q5 | `template-validator.detectDocumentType` 새 구조 인식 | `docs/x/01-plan/main.md` 경로 전달 | 단위 테스트 간접 | `'plan'` 반환 | P0 | ✅ Pass (간접) |
...
| E3 | `/plan/` sep 경계 vs `plan` 단독 | `docs/foo/01-plan/main.md` vs `docs/foo/plans.md` | 전자만 `'plan'` 판정 | ✅ Pass (sep 경계로 오매치 방지) |
...
|---------------|:------:|:-------:|-------|
| `docs/docs-structure-redesign/01-plan/main.md` | ✅ | ✅ | v1.1 |
| `docs/docs-structure-redesign/02-design/main.md` | ✅ | ✅ | v1.1 |
| `docs/docs-structure-redesign/02-design/cso-review.md` | ✅ | ✅ | sub-doc |
| `docs/docs-structure-redesign/03-do/main.md` | ✅ | ✅ | v1.0 |
| `docs/docs-structure-redesign/04-qa/main.md` | ✅ | ✅ | 본 문서 |
