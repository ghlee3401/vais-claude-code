...
> 참조: `docs/docs-structure-redesign/plan/main.md`, `docs/docs-structure-redesign/design/main.md`, `docs/docs-structure-redesign/design/cso-review.md`
...
- `infra-architect`: `docs/{feature}/design/infra.md`
- `backend-engineer`, `frontend-engineer`: `docs/{feature}/design/interface-contract.md`
- `product-researcher`: `docs/{feature}/do/research.md`
- `product-strategist`: `docs/{feature}/do/strategy.md`
- `ui-designer` review: `docs/{feature}/design/review.md`
- 본 피처 dogfooding: `docs/docs-structure-redesign/design/cso-review.md`
...
- 이유: 피처 중심 구조에선 ideation 산출물이 `docs/{feature}/ideation/main.md`에 동적 생성되므로 고정 디렉토리 존재는 더 이상 유효한 지표 아님
