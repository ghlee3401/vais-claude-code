...
> 참조 문서: `docs/docs-structure-redesign/plan/main.md`
...
|-----------------|-------------------|------|
| ``docs/01-plan/cto_{feature}.plan.md`` | ``docs/{feature}/plan/main.md`` | CTO 기본 plan |
| ``docs/02-design/cto_{feature}.design.md`` | ``docs/{feature}/design/main.md`` | CTO 기본 design |
| ``docs/02-design/infra-architect_{feature}.design.md`` | ``docs/{feature}/design/infra.md`` | **sub-doc 예외 적용** (infra 특화 산출물) |
| ``docs/03-do/{role}_{feature}.do.md`` | ``docs/{feature}/do/main.md`` | 실행 산출물 |
| ``docs/04-qa/{role}_{feature}.qa.md`` | ``docs/{feature}/qa/main.md`` | QA 산출물 |
| ``docs/05-report/{role}_{feature}.report.md`` | ``docs/{feature}/report/main.md`` | 보고서 |
