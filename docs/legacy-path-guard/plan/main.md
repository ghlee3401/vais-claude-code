...
| `docs/legacy-path-guard/plan/main.md` | create | 본 문서 |
...
|------|--------|
| 기획 (CEO) | 본 문서 ✅ |
| 설계 (COO) | `docs/legacy-path-guard/design/main.md` — hook 스크립트 구조 + 설치 흐름 |
| 구현 (COO + CTO 협업) | `docs/legacy-path-guard/do/main.md` + 실제 스크립트/README |
| QA (CSO 또는 CTO) | `docs/legacy-path-guard/qa/main.md` — SC-01~06 검증 |
| 보고 | `docs/legacy-path-guard/report/main.md` |
