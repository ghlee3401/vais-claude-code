...
> 참조: `docs/legacy-path-guard/01-plan/main.md`, `docs/legacy-path-guard/02-design/main.md` (v1.1)
...
| 4 | `docs/legacy-path-guard/03-do/main.md` | create | 본 Do 문서 |
...
```sh
# ── legacy-path-guard ──────────────────────────────────────────────
# @see docs/legacy-path-guard/02-design/main.md §5.1
