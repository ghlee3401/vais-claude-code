...
> 참조 문서: `docs/legacy-path-guard/01-plan/main.md`, `docs/legacy-path-guard/02-design/main.md` (v1.1), `docs/legacy-path-guard/03-do/main.md`, `docs/legacy-path-guard/04-qa/cso-review.md`
