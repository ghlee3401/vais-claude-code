...
> 참조 문서: `docs/legacy-path-guard/01-plan/main.md`, `docs/legacy-path-guard/02-design/main.md` (v1.1), `docs/legacy-path-guard/03-do/main.md`, `docs/legacy-path-guard/04-qa/main.md`, `docs/legacy-path-guard/04-qa/cso-review.md`
...
|-------|:------:|------------|
| Plan (CEO) | ✅ | `docs/legacy-path-guard/01-plan/main.md` v1.0 — CEO 전략 plan, (a)+(c) 범위 확정, 담당 COO |
| Design (COO) | ✅ | `docs/legacy-path-guard/02-design/main.md` v1.1 — ripgrep→bash 전환, 기존 `.hooks/` 재사용 결정 |
| Do (COO) | ✅ | `docs/legacy-path-guard/03-do/main.md` — 3 modify + 1 create, 격리 repo 수동 검증 Pass |
| QA — CSO 독립 | ✅ | `docs/legacy-path-guard/04-qa/cso-review.md` — 5 Gate Pass, Blocker 1건 즉시 해결 |
| QA — COO 공식 | ✅ | `docs/legacy-path-guard/04-qa/main.md` — SC 5 Met + 1 Partial, OWASP Pass, 최종 Pass |
| Report | ✅ | 본 문서 |
