...
>
> Virtual AI C-Suite for software development (v1.3.0)
> Claude Code marketplace plugin: `vais-code` — organization-in-a-box GA

## What This Project Is

**vais-code 정체성 (v1.3.0)**: *organization-in-a-box* — PO 1 명이 부서장 OJT 매뉴얼 (도메인 지식 박제) 을 통해 가상 C-Suite 조직을 운영하는 도구. 부서장 OJT 4 요소 (framework + 실무 단계 + 의사결정 패턴 + 산출물 양식) 가 grep 가능 영역에 박제되어 vanilla CC 와 차별화.
