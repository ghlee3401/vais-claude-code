...
| Do | frontend + backend | 병렬 구현 (Agent 병렬 호출) | `docs/03-do/{feature}.do.md` + 구현 코드 |
| Check | qa | 빌드+테스트+갭 분석 | `docs/04-qa/{feature}.qa.md` |
| Report | 직접 | memory 기록 + 완료 보고서 | `docs/05-report/{feature}.report.md` |
...
| context | 사용자 요구사항 또는 CPO PRD (`docs/00-prd/{feature}.prd.md`) |

### Output
| 산출물 | 경로 |
|--------|------|
| 기획서 | `docs/01-plan/{feature}.plan.md` |
| 설계서 | `docs/02-design/{feature}.design.md` |
| 구현 로그 | `docs/03-do/{feature}.do.md` |
| QA 분석 | `docs/04-qa/{feature}.qa.md` |
| 보고서 | `docs/05-report/{feature}.report.md` |
...
frontend+backend 완료 후 `docs/03-do/{feature}.do.md` 생성:
