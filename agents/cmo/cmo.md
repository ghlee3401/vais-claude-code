...
| `do` | Do 단계만 실행 → CP-2 확인 후 seo/copywriter/growth 위임 | `docs/03-do/cmo_{feature}.do.md` |
...
B. 표준 범위 ← 권장
   - 실행: 마케팅 전략 수립 + seo + copywriter
   - 산출물: 전략 문서 + SEO 감사 + 마케팅 카피
   - 적합: 신규 기능 출시 마케팅

C. 확장 범위
   - 실행: 표준 + growth (퍼널 분석) + 콘텐츠 캘린더
