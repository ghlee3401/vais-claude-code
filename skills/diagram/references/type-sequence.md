> 원본: cathrynlavery/diagram-design main@9874ad7 `references/type-sequence.md` (MIT, 2026-09-17 가져와 수정)

# Sequence — 시퀀스

**Best for:** request/response flows, protocol exchanges, multi-actor interactions over time, API call traces, incident reconstructions, auth/token refresh paths with branching. VAIS 8단계(API 규약)의 요청·응답 설명에 맞는다.
