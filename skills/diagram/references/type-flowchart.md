> 원본: cathrynlavery/diagram-design main@9874ad7 `references/type-flowchart.md` (MIT, 2026-09-17 가져와 수정)

# Flowchart — 흐름도

**Best for:** decision logic, algorithms, user-facing branching flows ("Should I…?"), onboarding routing, support-triage trees. VAIS 3단계(화면 정의서)의 화면 흐름은 이 유형이 기본이다.

## Layout conventions
- Shape carries type, not color:
  - **Oval** (`rx=20`) — start / end
  - **Rectangle** (`rx=6`) — step / action / 화면
