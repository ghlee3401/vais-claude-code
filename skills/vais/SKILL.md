...
| `ceo [feature]` | CEO 에이전트 — 비즈니스 전략 + C-Suite 오케스트레이션 |
| `cpo [feature]` | CPO 에이전트 — 제품 방향 + PRD 생성 + 로드맵 |
| `cto [feature]` | CTO 에이전트 — 기술 방향 설정 + 전체 오케스트레이션 |
| `cmo [feature]` | CMO 에이전트 — 마케팅 전략 (SEO는 seo agent에 위임) |
| `cso [feature]` | CSO 에이전트 — 보안/검증 오케스트레이션 (sub-agent 위임) |
