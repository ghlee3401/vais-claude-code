...
| `cto [feature]` | CTO — 기술 전체 오케스트레이션 (plan→design→architect→backend→frontend→qa, 각 단계마다 확인) |
...
> **폴더 구분**: `phases/` = C-Suite 방법론 (ceo, cto, cmo, cso, cpo, cfo, coo, absorb 등) | `utils/` = 유틸리티 (commit, status, help, init, next, report, test)
