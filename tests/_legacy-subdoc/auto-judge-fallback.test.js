 ...
 *
 * [LEGACY] 1.0.0 에서 _tmp/ fallback 로직 제거됨.
 * AC-REL-5 migration-only fixture 격리 — tests/_legacy-subdoc/ 에 보존 (기본 미실행).
...
describe('auto-judge — judgeCTO _tmp/qa-engineer.md fallback (legacy)', () => {
